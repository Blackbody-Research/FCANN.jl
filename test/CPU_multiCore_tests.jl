...
filename = string(name, "_10_input_", [], "_hidden_2_output_0.0_L2_Inf_maxNorm_0.002_alpha_ADAMAX", backend, ".csv")
...
filename = string(name, "_10_input_", [2, 2], "_hidden_2_output_0.0_L2_Inf_maxNorm_0.002_alpha_ADAMAX", backend, ".csv")
rm(string("1_costRecord_", filename))
rm(string("1_timeRecord_", filename))
rm(string("1_performance_", filename))
rm(string("1_params_", filename[1:end-4]))
