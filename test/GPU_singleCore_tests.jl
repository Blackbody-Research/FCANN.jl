...
if backend != :GPU
    ...
    multiTrain(name, 200, 1024, [2, 2], 0.0f0, 1.0f0, 0.002f0, 0.1f0, 2, 1, costFunc = "normLog")
    multiTrain(name, 200, 1024, [2, 2], 0.0f0, 1.0f0, 0.002f0, 0.1f0, 2, 2, costFunc = "normLog")
    println("TEST PASSED")
    println()
